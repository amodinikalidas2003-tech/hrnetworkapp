  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <MenuItem href={`/${locale}/hr-dashboard`} icon={<i className='tabler-chart-pie' />}>
            HR Dashboard
          </MenuItem>
        ...
        <MenuSection label={dictionary['navigation'].formsAndTables}>
          <MenuItem href={`/${locale}/organization`} icon={<i className='tabler-sitemap' />}>
            Organization
          </MenuItem>
          <MenuItem href={`/${locale}/assessments`} icon={<i className='tabler-clipboard-list' />}>
            Assessments
          </MenuItem>
          <MenuItem href={`/${locale}/files`} icon={<i className='tabler-file-upload' />}>
            File Archive
          </MenuItem>
          <SubMenu label="No-Code Dynamic Forms" icon={<i className='tabler-layout-board' />}>
            <MenuItem href={`/${locale}/forms`}>Form List</MenuItem>
            <MenuItem href={`/${locale}/forms/builder`}>Form Builder</MenuItem>
          </SubMenu>
